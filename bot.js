...
async function showCountriesList(ctx, serviceName) {
    ...
    countries.forEach((country, index) => {
        ...
        // Tunisia [TN] (৳0.50) [Avail: 12] - দেশে কয়টা নাম্বার Available আছে তা এখানে দেখাবে
        const buttonText = `\({flag}\){cleanCountryName} [\({isoCode}] (৳\){rate.toFixed(2)}) [Avail: ${availableStock}]`;
        
        // ডাবল কোলন (::) সেপারেটর ব্যবহার করা হচ্ছে
...
// ডাবল কোলন (::) কাস্টম সেপারেটর অনুযায়ী হ্যান্ডলার আপডেট
